...
#define ASSERT_EQUAL_CURSOR_POS(expected_row, expected_col, actual) if (!assert_equal_cursor_pos((Position){.row=expected_row,.col=expected_col}, actual)) return ASSERT_RESULT_FAILURE
